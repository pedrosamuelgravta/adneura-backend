...
strategic_goal_router = APIRouter(
    prefix="/strategic_goal", tags=["StrategicGoal"])
...
async def get_all_strategic_goals(
    ...
    if user_id:
        return await StrategicGoalService.get_all_strategic_goals_by_user(user_id, session)
...
async def get_strategic_goal_by_id(
    ...
    return await StrategicGoalService.get_strategic_goal_by_id(strategic_goal_id, session)


@strategic_goal_router.get("/{brand_id}", response_model=List[StrategicGoalReturn])
...
async def update_strategic_goal(
    ...
    return await StrategicGoalService.update_strategic_goal(strategic_goal_id, strategic_goal, session)


@strategic_goal_router.patch("/{strategic_goal_id}", response_model=StrategicGoalReturn)
async def archive_strategic_goal(
    ...
    return await StrategicGoalService.archive_strategic_goal(strategic_goal_id, strategic_goal, session)


@strategic_goal_router.delete("/{strategic_goal_id}", response_model=StrategicGoalReturn)
...
@strategic_goal_router.delete("/delete_all/{brand_id}", response_model=List[StrategicGoalReturn])
async def delete_all_strategic_goals_by_brand_id(
    brand_id: UUID,
    session: SessionDep,
    current_user: UserReturn = Depends(get_current_active_user),
) -> List[StrategicGoalReturn]:
    return await StrategicGoalService.delete_all_strategic_goals_by_brand_id(brand_id, session)
